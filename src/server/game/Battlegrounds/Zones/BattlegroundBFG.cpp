...
bool BattlegroundBFG::SetupBattleground()
{
    for (int i = 0; i < BG_BFG_DYNAMIC_NODES_COUNT; ++i)
    {
        if (!AddObject(BG_BFG_OBJECT_BANNER_NEUTRAL + 8*i, BG_BFG_OBJECTID_NODE_BANNER_0 + i, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_BANNER_CONT_A + 8*i, BG_BFG_OBJECTID_BANNER_CONT_A, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_BANNER_CONT_H + 8*i, BG_BFG_OBJECTID_BANNER_CONT_H, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_BANNER_ALLY + 8*i, BG_BFG_OBJECTID_BANNER_A, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_BANNER_HORDE + 8*i, BG_BFG_OBJECTID_BANNER_H, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_AURA_ALLY + 8*i, BG_BFG_OBJECTID_AURA_A, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_AURA_HORDE + 8*i, BG_BFG_OBJECTID_AURA_H, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            || !AddObject(BG_BFG_OBJECT_AURA_CONTESTED + 8*i, BG_BFG_OBJECTID_AURA_C, BG_BFG_NodePositions[i][0], BG_BFG_NodePositions[i][1], BG_BFG_NodePositions[i][2], BG_BFG_NodePositions[i][3], 0, 0, std::sin(BG_BFG_NodePositions[i][3]/2), std::cos(BG_BFG_NodePositions[i][3]/2), RESPAWN_ONE_DAY)
            )
        {
            sLog->outError(LOG_FILTER_SQL, "BattleGroundBG: Failed to spawn some object Battleground not created!");
            return false;
        }
    }
    ...
    {
        sLog->outError(LOG_FILTER_SQL, "BattleGroundBG: Failed to spawn door object Battleground not created!");
        return false;
    }
    ...
    for (int i = 0; i < BG_BFG_DYNAMIC_NODES_COUNT; ++i)
    {
        if (!AddObject(BG_BFG_OBJECT_SPEEDBUFF_LIGHTHOUSE + 3 * i, Buff_Entries[0], BG_BFG_BuffPositions[i][0], BG_BFG_BuffPositions[i][1], BG_BFG_BuffPositions[i][2], BG_BFG_BuffPositions[i][3], 0, 0, std::sin(BG_BFG_BuffPositions[i][3]/2), std::cos(BG_BFG_BuffPositions[i][3]/2), RESPAWN_ONE_DAY)
            ...
            sLog->outError(LOG_FILTER_SQL, "BattleGoundBG: Failed to spawn buff object!");
    }
...
void BattlegroundBFG::Reset()
{
    ...
    m_ReputationTics = (isBGWeekend) ? BG_BFG_BGBGWeekendReputationTicks : BG_BFG_NotBGBGWeekendReputationTicks;
