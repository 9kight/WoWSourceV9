...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    // Currency
    PrepareStatement(CHAR_SEL_PLAYER_CURRENCY, "SELECT currency, week_count, total_count, week_cap, new_cap FROM character_currency WHERE guid = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_UPD_PLAYER_CURRENCY, "UPDATE character_currency SET week_count = ?, total_count = ?, week_cap = ?, new_cap = ? WHERE guid = ? AND currency = ?", CONNECTION_ASYNC);
    PrepareStatement(CHAR_REP_PLAYER_CURRENCY, "REPLACE INTO character_currency (guid, currency, week_count, total_count, week_cap, new_cap) VALUES (?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
